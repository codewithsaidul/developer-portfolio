...
export const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "ShadCn", icon: Layers, color: "#0EA5E9" },
      { name: "Tailwind CSS", icon: Palette, color: "#38BDF8" },
      { name: "Material UI", icon: AppWindow, color: "#007FFF" },
...

  {
    ...
    skills: [
      ...
      { name: "Express", icon: Server, color: "#303030" },
      { name: "Node.js", icon: Cpu, color: "#339933" },
      { name: "REST API", icon: Server, color: "#0E7490" },
      { name: "PostgreSQL", icon: Database, color: "#4169E1" },
      { name: "GraphQL", icon: Puzzle, color: "#E535AB" },
      { name: "MySQL", icon: Database, color: "#00758F" },
      { name: "Socket.io", icon: Webhook, color: "#000000" },
    ],
  },

  {
    ...
    skills: [
      { name: "Git", icon: Code, color: "#F1502F" },
      { name: "GitHub", icon: Code, color: "#000000" },
      { name: "VS Code", icon: Code, color: "#007ACC" },
      { name: "ChatGPT", icon: Lightbulb, color: "#00A67E" },
      { name: "N8N", icon: Webhook, color: "#EF4444" },
      { name: "Figma", icon: PenTool, color: "#F24E1E" },
      { name: "Vercel", icon: Cloud, color: "#000000" },
      { name: "Netlify", icon: Cloud, color: "#00C7B7" },
      { name: "Lovable AI", icon: Lightbulb, color: "#9333EA" },
      { name: "V0 AI", icon: Lightbulb, color: "#6366F1" },
    ],
  },
];
